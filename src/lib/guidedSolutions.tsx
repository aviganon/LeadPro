...
const crane: GuidedSol = {
  id: 'crane-moment',
  title: 'עגורן צריח — עומס בטוח ומשקולת מבחן',
  question: 'מומנט העבודה הבטוח של עגורן צריח הוא 60 טון·מ\'. מה העומס הבטוח ברדיוס 20 מ\', ומה משקל משקולת המבחן לבדיקת גובל עומס יתר?',
  steps: [
...
const cable: GuidedSol = {
  ...
  question: 'כבל פלדה נקרע בכוח של 84 טון. מהו עומס העבודה הבטוח להרמת בני אדם (מקדם ביטחון 10)?',
  steps: [
