...
import { READING_CATEGORIES, READING_SENTENCES, RHYME_GROUPS, SYLLABLE_WORDS } from './readingContent'
...
const HEBREW: Record<number, Q[]> = {
  1: [
    { prompt: 'מָה הַהֵפֶךְ מִ"גָּדוֹל"?', ...textMc('קָטָן', ['אָרֹךְ', 'כָּבֵד', 'רָחָב']), difficulty: 1 },
    { prompt: 'מָה הַהֵפֶךְ מִ"יוֹם"?', ...textMc('לַיְלָה', ['בֹּקֶר', 'עֶרֶב', 'שָׁעָה']), difficulty: 1 },
    { prompt: 'מָה הַהֵפֶךְ מִ"חַם"?', ...textMc('קַר', ['רָטֹב', 'יָבֵשׁ', 'חָמִים']), difficulty: 1 },
    { prompt: 'אֵיזוֹ מִילָה הִיא רַבִּים שֶׁל "כֶּלֶב"?', ...textMc('כְּלָבִים', ['כַּלְבָּה', 'כְּלַבְלַב', 'כֶּלֶב']), difficulty: 2 },
    { prompt: 'בְּאֵיזוֹ אוֹת מַתְחִילָה הַמִּילָה "שֶׁמֶשׁ"?', ...textMc('שׁ', ['ס', 'ת', 'מ']), difficulty: 2 },
    { prompt: 'מָה הַהֵפֶךְ מִ"פָּתוּחַ"?', ...textMc('סָגוּר', ['רָחָב', 'רֵיק', 'מָלֵא']), difficulty: 3 },
  ],
  2: [
    { prompt: 'מָה הַהֵפֶךְ מִ"מָהִיר"?', ...textMc('אִטִּי', ['חָזָק', 'גָּבוֹהַּ', 'רָחוֹק']), difficulty: 1 },
    { prompt: 'מָה הַהֵפֶךְ מִ"שָׂמֵחַ"?', ...textMc('עָצוּב', ['כּוֹעֵס', 'עָיֵף', 'רָעֵב']), difficulty: 1 },
    { prompt: 'מָה מִילָה נִרְדֶּפֶת לְ"יָפֶה"?', ...textMc('נֶחְמָד', ['גָּדוֹל', 'מָהִיר', 'קַר']), difficulty: 2 },
    { prompt: 'מָה הָרַבִּים שֶׁל "יֶלֶד"?', ...textMc('יְלָדִים', ['יַלְדָּה', 'יַלְדוֹן', 'יְלָדוֹת']), difficulty: 2 },
    { prompt: 'אֵיזוֹ מִילָה הִיא נְקֵבָה?', ...textMc('מוֹרָה', ['מוֹרֶה', 'תַּלְמִיד', 'יֶלֶד']), difficulty: 3 },
    { prompt: 'מָה הַהֵפֶךְ מִ"עוֹלֶה"?', ...textMc('יוֹרֵד', ['רָץ', 'עוֹמֵד', 'נוֹפֵל']), difficulty: 3 },
  ],
  3: [
  ...
  for (const s of SUBJECTS) {
    ...
    for (let grade = 1; grade <= 6; grade++) {
      ...
      if (s.id === 'hebrew' && grade === 1) {
        ...
        // Firestore אינו תומך במערך-בתוך-מערך — עוטפים כל קבוצה באובייקט { words }.
        docs.push({ collection: 'games', id: 'hebrew-g1-read-rhyme', data: { subjectId: 'hebrew', type: 'reading', level: 'elementary', grade, titleHe: 'חרוזים', titleEn: 'Rhymes', config: { mode: 'rhyme', groups: RHYME_GROUPS.map((words) => ({ words })) } } })
        docs.push({ collection: 'games', id: 'hebrew-g1-read-syllable', data: { subjectId: 'hebrew', type: 'reading', level: 'elementary', grade, titleHe: 'כמה הברות?', titleEn: 'How Many Syllables', config: { mode: 'syllable', words: SYLLABLE_WORDS } } })
      }
